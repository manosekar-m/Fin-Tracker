    ...
    return Scaffold(
      ...
      body: Consumer<TransactionProvider>(
        builder: (context, provider, child) {
          ...
          final monthTransactions = provider.filteredTransactions;
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (monthTransactions.isEmpty)
                    ...
                    ...monthTransactions.take(5).map((tx) => _buildTransactionItem(tx)),
  ...
  Widget _buildBalanceCard(BuildContext context, TransactionProvider provider) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Balance for ${DateFormat('MMMM').format(provider.selectedMonth)}',
